...
/// <summary>Owns the single Roslyn workspace and solution shared by all index services.</summary>
public sealed class IndexedProjectContext : IDisposable
{
    private readonly MSBuildWorkspace _workspace;
    private readonly IDisposable _warningRegistration;

    private IndexedProjectContext(MSBuildWorkspace workspace, IDisposable warningRegistration, Solution solution, string inputPath, IReadOnlyList<string> warnings)
    {
